package com.example.lookpin.feature.photolist.model
...
data class PhotoUiModel(
    ...
    companion object {
        private fun toUiModel(photo: Photo) = PhotoUiModel(
            id = photo.id,
        ...
        val diffUtil = object : DiffUtil.ItemCallback<PhotoUiModel>() {
